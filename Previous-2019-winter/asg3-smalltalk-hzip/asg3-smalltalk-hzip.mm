...
.SIZE 12 14
.INITR* \n[.F]
.TITLE CMPS-112 Winter\~2019 Project\~3 \
"Smalltalk\(:) Object Orientation"
.RCS "$Id: asg3-smalltalk-hzip.mm,v 1.30 2019-02-11 15:52:24-08 - - $"
.PWD
.URL
.de ULCB
...
.LI
Reopen the input file and,
for each byte read from the input file,
...
used\(??
.H 1 "\f[CB]\[Do]PATH\f[R]"
For interactive use,
.V= \[Do]PATH\
environment variable should contain
.VTCODE* 1 /afs/cats.ucsc.edu/courses/cmps112-wm/usr/smalltalk/bin
.H 1 "What to submit"
Submit a
.V= README
and
